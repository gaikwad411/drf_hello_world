...
from drf_api.file_upload_api import FileUploadUsingDBModel, FileUploadWithoutDBModel, MultipleFilesUpload
...
urlpatterns = [
    ...
    url('^multiple-file-uploads-api/$', MultipleFilesUpload.as_view()),
